...
<c:import url="../Panels/MainPanel.jsp"></c:import>
    ...
    <form method="post" enctype="multipart/form-data" class="update-profile-form">
        ...
        <input type="hidden" id="community" name="community" value="${community.name}" class="form-input">
        <br>
        ...
        <br>
        <label for="image" class="form-label" class="form-label">Image:</label>
        <input type="file" id="image" name="image" accept="image/*" class="form-input">
        <br>
        <input type="submit" value="Обновить группу" class="form-submit-btn">
    </form>
    </c:otherwise>
    </c:choose>
