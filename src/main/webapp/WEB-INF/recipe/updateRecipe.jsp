...
<form method="post" enctype="multipart/form-data" class="update-profile-form">
    ...
    <br>
    <label for="ingredients" class="form-label">Ингидиенты</label>
    <input type="text" id="ingredients" name="ingredients" class="form-input">
    <br>
    <label for="stages" class="form-label">Стадии</label>
    <input type="text" id="stages" name="stages" class="form-input">
    <br>
